...
class MapDesignModule {
    ...
    @Singleton
    @Provides
    fun providesMapDesignArgs(): MapDesignArgs {
        return object : MapDesignArgs {
            /**
             * these are the values that must be set
             * this is used by the module and all screens with the same viewModel
             */
            override val showDistanceIfAvailable = true
            override val showRouteButton = true
            override val showImages = true
            override val appStoreLink: String = ""
            override val categoryColumnCount = 4
            override val cityName: Int = R.string.city_name
            override val mapCardHeight: Dp = 200.dp
            override val poiShareText: Int = R.string.global_share_text // !!! ändern
            override val mapInitialZoomLevel: Float = 8.0f
            override val showDefaultAll: Boolean = false
            override val showSamplePOIs: Int = 8
            override val skipFilterWhenEmpty: Boolean = false
            override val mapStyle: Int = R.raw.map_style_without_any
            /**
             * -> overrides that must be set
             */
            override val vShowMoreOption: Boolean = true
            override val vModuleTitle: Int = R.string.map_title
            override val vWidgetShowMoreOption: Boolean = true
            override val vIsWidgetVisible: Boolean = true
            override val vWidgetTitle: Int = R.string.map_title
            /**
            ...
            override val mShowMoreText: Int = R.string.poi_more_text
