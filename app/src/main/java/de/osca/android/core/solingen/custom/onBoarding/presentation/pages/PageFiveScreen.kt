...
fun PageFiveScreen(
    ...
    Column(
        ...
        if(design.locationImage != null) {
            Image(
                painter = painterResource(id = design.locationImage!!),
        ...
        SimpleSpacedList(
            ...
            Text(
                text = stringResource(id = design.locationTitle),
            ...
            SimpleSpacedList(
                ...
                for(item in design.contentPage4) {
                    Text(
        ...
        Column {
            MainButton(
                buttonText = if (permissionState.status.isGranted) {
                    stringResource(id = R.string.onBoarding_location_active)
                } else stringResource(id = R.string.onBoarding_location_grant),
                onClick = {
