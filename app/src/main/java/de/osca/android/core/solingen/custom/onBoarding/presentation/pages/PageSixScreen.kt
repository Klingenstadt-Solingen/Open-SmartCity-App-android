...
fun PageSixScreen(
    ...
    Column(
        ...
        if(design.welcomeImage != null) {
            Image(
                painter = painterResource(id = design.welcomeImage!!),
        ...
        SimpleSpacedList(
            ...
            Text(
                text = stringResource(id =design.welcomeTitle),
            ...
            SimpleSpacedList(
                ...
                for(item in design.contentPage5) {
                    Text(
        ...
        Column {
            MainButton(
                buttonText = stringResource(id = R.string.onBoarding_start_button),
                onClick = {
                    onClick()
                },
                masterDesignArgs = masterDesignArgs,
