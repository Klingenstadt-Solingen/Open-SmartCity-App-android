...
import de.osca.android.core.solingen.ui.theme.CLR_TextHint
import de.osca.android.waste.presentation.args.WasteDesignArgs
import javax.inject.Singleton

@Module
@InstallIn(SingletonComponent::class)
class WasteDesignModule {

    @Singleton
    @Provides
    fun providesWasteDesignArgs(): WasteDesignArgs {
        return object : WasteDesignArgs {
            /**
             * these are the values that must be set
             * this is used by the module and all screens with the same viewModel
             */
            override val subTitleText = CLR_TextHint()
            override val isWasteIconRound = true
            override val dayIconSize = 10.dp
            override val isNotificationCombined = false
            override val isIconBackgroundColored = true
            override val isIconForegroundBlack = true
            override val showIconInAppointments = true
            override val showWasteWhatElement = true
            override val showWasteSpecialElement = true
            override val showGreenWasteElement = true
            override val showClothesWasteElement = true
            override val overviewUrl: String? = null
            override val showDetailedWasteInfo: Boolean = true
            override val wasteInfoText: String? = null
            override val wasteInfoAtBottom: Boolean = true
            override val showHintForFilter: Boolean = false
            override val showHintForNoHouseNumber: String? = null
            override val mapStyle: Int? = R.raw.map_style_without_any
            /**
             * -> overrides that must be set
             */
            override val vShowMoreOption: Boolean = true
            override val vModuleTitle: Int = R.string.waste_title
            override val vWidgetShowMoreOption: Boolean = true
            override val vIsWidgetVisible: Boolean = true
            override val vWidgetTitle: Int = R.string.waste_title_appointments
            /**
            ...
            override val mRootCardSpacing: Dp? = 40.dp
