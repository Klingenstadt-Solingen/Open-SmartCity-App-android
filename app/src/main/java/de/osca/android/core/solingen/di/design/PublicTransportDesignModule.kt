...
class PublicTransportDesignModule {

    @Singleton
    @Provides
    fun providesPublicTransportDesignArgs(): PublicTransportDesignArgs {
        return object : PublicTransportDesignArgs {
            /**
             * -> overrides that must be set
             */
            override val vShowMoreOption: Boolean = true
            override val vModuleTitle: Int = R.string.public_transport_title
