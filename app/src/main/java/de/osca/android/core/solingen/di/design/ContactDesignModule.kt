...
class ContactDesignModule {

    @Singleton
    @Provides
    fun providesContactDesignArgs(): ContactDesignArgs {
        return object : ContactDesignArgs {
            /**
            ...
            override val vModuleTitle: Int = R.string.contact_title
            /**
