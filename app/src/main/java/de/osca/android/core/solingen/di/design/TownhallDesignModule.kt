...
class TownhallDesignModule {

    @Singleton
    @Provides
    fun providesTownhallDesignArgs(): TownhallDesignArgs {
        return object : TownhallDesignArgs {
            /**
            ...
            override val showArrowIcon: Boolean = true
            override val showTownhallIcon: Boolean = true
            override val columnCount: Int = 3
            /**
             * -> overrides that must be set
             */
            override val vShowMoreOption: Boolean = true
            override val vModuleTitle: Int = R.string.townhall_title
            override val vWidgetShowMoreOption: Boolean = true
            override val vIsWidgetVisible: Boolean = true
            override val vWidgetTitle: Int = R.string.dashboard_townhall
            /**
