...
class MobilityDesignModule {

    @Singleton
    @Provides
    fun providesMobilityDesignArgs(): MobilityDesignArgs {
        return object : MobilityDesignArgs {
            /**
             * these are the values that must be set
             * this is used by the module and all screens with the same viewModel
             */
            override val mapCardHeight: Dp = 280.dp
            ...
            override val vModuleTitle: Int = R.string.mobility_title
            override val vWidgetShowMoreOption: Boolean = true
            override val vWidgetTitle: Int = R.string.mobility_title
            /**
