...
class PressReleaseDesignModule {

    @Singleton
    @Provides
    fun providesPressReleaseDesignArgs(): PressReleaseDesignArgs {
        return object : PressReleaseDesignArgs {
            /**
            ...
            override val showPressImage = true
            override val showClockIcon = true
            override val showDate = true
            override val showReadingTime = true
            override val previewCountForWidget = 5
            override val appStoreLink: String = "SolingenAppStoreLink"
            /**
             * -> overrides that must be set
             */
            override val vShowMoreOption: Boolean = true
            override val vModuleTitle: Int = R.string.press_release_title
            override val vWidgetShowMoreOption: Boolean = true
            override val vIsWidgetVisible: Boolean = true
            override val vWidgetTitle: Int = R.string.press_release_dashboard_news
            /**
