...
class DefectDesignModule {

    @Singleton
    @Provides
    fun providesDefectDesignArgs(): DefectDesignArgs {
        return object : DefectDesignArgs {
            /**
             * -> overrides that must be set
             */
            override val vShowMoreOption: Boolean = true
            override val vModuleTitle: Int = R.string.defect_title
